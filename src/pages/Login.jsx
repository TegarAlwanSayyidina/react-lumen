...
export default function Login() {
    ...
    const errorMassage = new URLSearchParams(location.search).get('massage');
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            {/**     */}
                            {
                                ...
                                <div class="bg-red-100 border-t border-b border-red-500 text-red-700 px-4 py-3" role="alert">
                                    <p class="front-bold">Gagal memproses halaman</p>
                                    <p class="text-sm">{errorMassage}</p>
                                </div>
                            ) : ''
                            }
                            {/* ternary untuk mengecek apakah stage errpr memiliki data, jika iya munculkan datanya dengan looping*/}
                            {
