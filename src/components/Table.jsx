...
export default function Table({ dataTh, dataTd, columnDb, buttonData, endpoints, columnDetail, judulModalEdit, inputData }) {
    ...
    return (
      ...
      <div className="flex justify-center mb-5"><br></br>
      {
      ...
      }
      {
          buttonData.includes("trash") ? (
              <Link to={'/stuffs/trash'} class="ml-3 text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 
                              ...
                              <td class="px-6 py-4">
                              {
                               ...
                               dark:text-red-500 hover:underline"> Delete</a>
                                    ...
                                    buttonData.includes("restore") ? (
                                        <a href="#" onClick={() => handleRestore(value.id)} class="font-medium text-orange-600
                             dark:text-orange-500 hover:underline">Restore | </a>
                                    ) : ''
                                }
                                {
                                    buttonData.includes("permanent-delete") ? (
                                        <a href="#" class="font-medium text-pink-600
                             dark:text-pink-500 hover:underline">Permanent Delete</a>
                                    ) : ''
                                }
                              </td>
                          </tr>
